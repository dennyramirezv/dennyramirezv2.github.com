			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="w-100 float-left">
						<form action="<?php echo site_url('home/paypal_checkout'); ?>" method="post" class="paypal-form">
			            ...
			            <form action="<?php echo site_url('home/stripe_checkout'); ?>" method="post" class="stripe-form">
			            	<hr class="border mb-4">
							<input type="hidden" name="total_price_of_checking_out" value="<?php echo $total_price_of_checking_out; ?>">
...
<script type="text/javascript">
	function selectedPaymentGateway(gateway){
		if(gateway == 'paypal'){
			...
			$(".stripe").css("border","2px solid #D3DCDD");
			$('.stripe-icon').hide();
			$('.stripe-form').hide();

			$(".offline").css("border","2px solid #D3DCDD");
			$('.offline-icon').hide();
			$('.offline-form').hide();
			...
			$(".paypal").css("border","2px solid #D3DCDD");
			$('.paypal-icon').hide();
			$('.paypal-form').hide();
